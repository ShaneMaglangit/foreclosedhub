...
type ComplexityRoot struct {
	...
	Query struct {
		Listings func(childComplexity int, limit int32) int
	}
}

type ListingResolver interface {
	FloorArea(ctx context.Context, obj *db.Listing) (float64, error)
}
type QueryResolver interface {
	Listings(ctx context.Context, limit int32) ([]*db.Listing, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.listings":
		...
		return e.complexity.Query.Listings(childComplexity, args["limit"].(int32)), true
...
func (ec *executionContext) field_Query_listings_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_listings_argsLimit(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["limit"] = arg0
...
func (ec *executionContext) _Listing_id(ctx context.Context, field graphql.CollectedField, obj *db.Listing) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Listing_address(ctx context.Context, field graphql.CollectedField, obj *db.Listing) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Listing_floorArea(ctx context.Context, field graphql.CollectedField, obj *db.Listing) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Listing().FloorArea(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Listing_price(ctx context.Context, field graphql.CollectedField, obj *db.Listing) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Query_listings(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Listings(rctx, fc.Args["limit"].(int32))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*db.Listing)
	fc.Result = res
	return ec.marshalNListing2ᚕᚖhomagochiᚋinternalᚋdbᚐListingᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Listing(ctx context.Context, sel ast.SelectionSet, obj *db.Listing) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "floorArea":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Listing_floorArea(ctx, field, obj)
				if res == graphql.Null {
...
func (ec *executionContext) marshalNListing2ᚕᚖhomagochiᚋinternalᚋdbᚐListingᚄ(ctx context.Context, sel ast.SelectionSet, v []*db.Listing) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNListing2ᚖhomagochiᚋinternalᚋdbᚐListing(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNListing2ᚖhomagochiᚋinternalᚋdbᚐListing(ctx context.Context, sel ast.SelectionSet, v *db.Listing) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
