...
export type GetListingsQuery = { __typename?: 'Query', listings: { __typename?: 'ListingConnection', nodes: Array<{ __typename?: 'Listing', id: any, address: string, price: any, lotArea: number, floorArea: number, occupancyStatus: OccupancyStatus, source: Source, latitude: number, longitude: number, images: Array<{ __typename?: 'ListingImage', id: any, url: string }> }> } };
